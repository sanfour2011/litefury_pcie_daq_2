...
// use only with mmap, xdma0_bypass has no DMA engine 
// do not use pread, pwrite, ... with xdma0_bypass, otherwise it returns EINVAL
// read returns the DMA descriptors of the engine, not CSR/BAR data
// write writes descriptor data to the DMA bypass BAR
