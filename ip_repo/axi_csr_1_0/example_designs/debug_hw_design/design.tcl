...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: axi_csr_0, and set properties
	set axi_csr_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_csr:1.0 axi_csr_0 ]
	...
	# Connect all clock & reset of axi_csr_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins axi_csr_0/CONTROL_STATUS_REG]
	connect_bd_net [get_bd_pins axi_csr_0/control_status_reg_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_csr_0/control_status_reg_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to axi_csr_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/axi_csr_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_axi_csr_0_CONTROL_STATUS_REG_* ]]
	puts $fp "set control_status_reg_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:axi_csr:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/axi_csr_hw_test.tcl
