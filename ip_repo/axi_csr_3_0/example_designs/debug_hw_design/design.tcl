...
proc create_ipi_design { offsetfile design_name } {
	...
	set axi_csr_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_csr:3.0 axi_csr_0 ]
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins axi_csr_0/axi_csr]
	connect_bd_net [get_bd_pins axi_csr_0/axi_csr_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_csr_0/axi_csr_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_axi_csr_0_axi_csr_* ]]
	puts $fp "set axi_csr_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:axi_csr:3.0]]]]
