...
REM
REM Generated by Vivado on Thu Aug 06 15:39:21 +0200 2026
...
echo "xvhdl --incr --relax -prj CSR_V3_0_tb_vhdl.prj"
call xvhdl  --incr --relax -prj CSR_V3_0_tb_vhdl.prj -log xvhdl.log
